  ...
  const badgeRequestItems = [
    {
      id: 501,
      title: 'Promise Kept General',
      dueDate: 'Jul 18, 10:00 AM', // Completed date
      committedDate: 'Jul 19, 2:00 PM', // Requested date
    ...
    },
    {
      id: 506, // Overdue item
      title: 'Teamwork',
      dueDate: dayjs().subtract(10, 'day').format('MMM D, hh:mm A'), // Actual completion date
      committedDate: dayjs().subtract(7, 'day').format('MMM D, hh:mm A'), // Actual request date, making it overdue for approval
      ...
      assignee: 'Alex Johnson',
      isOverdue: true, // Explicitly mark as overdue for approval
    },
  ];
