...
const OutlineIconValueCircle: React.FC<OutlineIconValueCircleProps> = ({
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
      <Box sx={{ position: 'relative', display: 'inline-flex', mb: 3 }}> {/* Adjusted margin-bottom for spacing between circle and value */}
      ...
      <Typography variant="h6" component="div" sx={{ fontWeight: 700, color: '#333', fontSize: '1.2rem', mb: 0.5 }}> {/* Adjusted margin-bottom for spacing between value and label */}
        {value}{unit}
      </Typography>
