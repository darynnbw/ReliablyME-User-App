...
const CommitmentListItem = React.forwardRef<HTMLDivElement, CommitmentListItemProps>(({
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ p: 2, '&:last-child': { pb: 1 } }}> {/* Adjusted pb to 1 */}
        ...
        <Box sx={{ flex: 1, minWidth: 0, alignSelf: 'center', display: 'flex', flexDirection: 'column' }}> {/* This box now controls its children in a column */}
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mt: 1, mb: 0 }}> {/* mt: 1 for consistent spacing, mb: 0 to remove extra space */}
            {/* Assignee Info */}
            <Stack direction="row" spacing={1} alignItems="center">
