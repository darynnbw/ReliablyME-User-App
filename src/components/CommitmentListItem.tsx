    ...
    >
      ...
      <CardContent sx={{ p: 2, '&:last-child': { pb: 2 }, display: 'flex', gap: 1.5 }}>
        ...
        <Box sx={{ flex: 1, minWidth: 0, alignSelf: 'center' }}>
          ...
          {isActionsPage ? (
            // This block is for the Actions page, where buttons should NOT be next to text
            <>
              ...
              {/* No action buttons here for isActionsPage, as per screenshot */}
            </>
          ) : (
            // This block is for non-Actions pages (e.g., Dashboard, Commitment Portfolio)
            // where buttons *are* displayed next to the text.
            <>
              <Typography variant="body2" sx={{ color: '#666', lineHeight: 1.5, mb: 1.5 }}>
                {description}
              </Typography>
