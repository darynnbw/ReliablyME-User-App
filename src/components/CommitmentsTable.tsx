...
const CommitmentsTable: React.FC<CommitmentsTableProps> = ({
  ...
  return (
    <TableContainer component={Paper} sx={{ boxShadow: 'none', border: '1px solid #e8eaed', borderRadius: 3, minHeight: 392, width: '100%', overflowY: 'scroll' }}>
      <Table sx={{ minWidth: 650, tableLayout: 'fixed' }} aria-label="commitments table">
        <TableHead sx={{ bgcolor: 'grey.50' }}>
          <TableRow>
            ...
            <TableCell sx={{ fontWeight: 'bold', color: 'text.primary', whiteSpace: 'nowrap', width: '50%' }}>
              Original Commitment
            </TableCell>
            ...
            <TableCell sx={{ fontWeight: 'bold', color: 'text.primary', whiteSpace: 'nowrap', width: '10%' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                Due Date
            ...
            <TableCell sx={{ fontWeight: 'bold', color: 'text.primary', whiteSpace: 'nowrap', width: '10%' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, pr: 0 }}>
                Committed Date
            ...
            commitments.map((commitment, index) => (
              <React.Fragment key={commitment.id}>
                ...
                >
                  ...
                  <TableCell sx={{ pr: 0 }}>{commitment.committedDate || 'N/A'}</TableCell>
                </TableRow>
